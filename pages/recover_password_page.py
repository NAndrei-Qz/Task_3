...
class RecoverPasswordPage(BasePage):
    ...
    def click_on_recovery_password_button(self):
        self.click_on_element(RecoverPasswordPageLocators.RECOVERY_PASSWORD_BUTTON, self.browser)
    ...
    def click_on_show_password_button(self):
        self.click_on_element(RecoverPasswordPageLocators.SHOW_PASSWORD_BUTTON, self.browser)
    ...
    def input_email_for_recovery(self):
        self.send_keys_to_input(RecoverPasswordPageLocators.EMAIL_FIELD_INPUT, TestData.EMAIL)
    
    @allure.step('Заполнение поля "Пароль"')
    def input_password_for_recovery(self):
        self.send_keys_to_input(RecoverPasswordPageLocators.PASSWORD_FIELD_INPUT, TestData.PASSWORD)
